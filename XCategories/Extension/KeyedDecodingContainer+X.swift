...
private extension __JSONDecoder {
    ...
    func unbox(_ value: Any, as type: Bool.Type) throws -> Bool? {
        ...
        if let number = value as? NSNumber {
            // Add a flag to coerce non-boolean numbers into Bools?
        ...
        /* If swift-corelibs-foundation doesn't change to use NSNumber, this code path will need to be included and tested:
    ...
    func unbox(_ value: Any, as type: Double.Type) throws -> Double? {
        ...
        /* swift-corelibs-foundation doesn't change to use NSNumber, this code path will need to be included and tested:
        } else if let double = value as? Double {
            return double
        } else if let int = value as? Int {
...
extension DecodingError {
    ...
    private static func _typeDescription(of value: Any) -> String {
        if value is NSNull {
            return "a null value"
        } else if value is NSNumber /* : If swift-corelibs-foundation isn't updated to use NSNumber, this check will be necessary: || value is Int || value is Double */ {
            return "a number"
